...
import { createTheme as createTheme$1, ThemeProvider as ThemeProvider$1 } from '@mui/material/styles';
...
function Layout({ sidebar, children, sidebarWidth = 220 }) {
    return (jsxs(Box$1, { sx: { display: "flex" }, children: [sidebar && sidebar, jsxs(Box$1, { children: [jsx(AppBar, { position: "fixed", elevation: 0, style: { left: sidebarWidth }, children: jsx(Toolbar, { disableGutters: true, sx: { pl: 2 }, children: jsx(Box$1, { children: "asdf@asedf.com" }) }) }), jsx(Toolbar, {}), jsx(Box$1, { component: "main", children: children })] })] }));
}
...
const theme = createTheme$1(themeConfig);
